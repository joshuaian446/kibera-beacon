        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              ] as { label: string; to: string }[]).map((link) => (
                <li key={link.label}>
                  <Link
                    to={link.to}
            ...
            <ul className="space-y-3">
              ...
              <li className="flex flex-col gap-2 text-sm">
                <div className="flex items-center gap-3">
                  ...
                  <a href="mailto:admin@copacentre.org" className="text-primary-foreground/80 hover:text-primary-foreground transition-smooth font-bold">
                    admin@copacentre.org
                  </a>
                </div>
                <div className="flex items-center gap-3 ml-8 text-xs">
                  <span className="text-primary-foreground/60 italic">Secondary:</span>
                  <a href="mailto:copacentre21@gmail.com" className="text-primary-foreground/70 hover:text-primary-foreground transition-smooth">
